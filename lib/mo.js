...
module.exports = {
    ...
    process: function(gateway, mo) { //subsriber update
        ...
        if (mo.service == 'ON' || mo.service == 'OUT' || mo.service == 'STOP' ||
            ...
            db.any('subscriber', filterSubscriber).then(exists => {
                if (exists) {
                    ...
                    db.update('subscriber', filterSubscriber, updateSubscriber).then(result => {
                    ...
                    db.save('subscriber', newSubscriber).then(result => {
