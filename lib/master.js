...
var master = {
    retrieveBroadcastInfo: (gateway, userName, shortCode) => {
        return new Promise(function(resolve, reject) {
            db.retrieveOne('masters', { 'gateway': gateway }).then(result => {
                ...
                broadcastInfo.extraMTParams = telcoParams;
                    ...
                    if (account.userName == userName) {
                        ...
                        for (j = 0; j < shortCodes.length; j++) {
                            if (shortCodes[j].shortCode == shortCode) {
                                ...
                                broadcastInfo.keywords = shortCodekeywords; //[keyword,price]
                                break; //found shortCode
                            }
                        }
                        break; //credentials
                    }
